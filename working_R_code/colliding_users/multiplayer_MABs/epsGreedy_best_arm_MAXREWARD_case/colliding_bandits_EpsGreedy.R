...
# save data
write_csv(final_join2_t, "/Users/girishnathan/work/code/R/colliding_bandits/1001_players_best_arm_rewards_full_2_explore_dep_arms.csv",
         col_names = T)

write_csv(final_user_rewards_t, "/Users/girishnathan/work/code/R/colliding_bandits/1001_players_final_user_rewards_full_2_explore_dep_arms.csv",
          col_names = T)

# save all plots

pdf("/Users/girishnathan/work/code/R/colliding_bandits/1001_players_best_arm_rewards_plots_full_2_explore_dep_arms.pdf")
g <- ggplot(data = final_join2_t, aes(x = log(n), y = log(m), colour = factor(n_arms))) + 
  geom_point() 
